...
export interface AllowlistRegistryInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "batchSetAllowed"
      | "isAllowed"
  ...
  getEvent(
    nameOrSignatureOrTopic: "AllowlistUpdated" | "OwnershipTransferred"
  ): EventFragment;

  encodeFunctionData(
    functionFragment: "batchSetAllowed",
...
export interface AllowlistRegistry extends BaseContract {
  connect(runner?: ContractRunner | null): AllowlistRegistry;
  waitForDeployment(): Promise<this>;

  interface: AllowlistRegistryInterface;
  ...
  batchSetAllowed: TypedContractMethod<
    [accounts: AddressLike[], allowed: boolean],
    [void],
    "nonpayable"
  >;

  isAllowed: TypedContractMethod<[account: AddressLike], [boolean], "view">;
  ...
  getFunction(
    nameOrSignature: "batchSetAllowed"
  ): TypedContractMethod<
    [accounts: AddressLike[], allowed: boolean],
    [void],
    "nonpayable"
