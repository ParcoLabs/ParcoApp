  ...
  return (
    <div className="p-4 md:p-8 max-w-6xl mx-auto space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-brand-black">My Properties</h1>
          <p className="text-sm text-brand-sage mt-1">Manage your tokenization submissions</p>
        </div>
        <button
          onClick={handleStartNewProperty}
          disabled={creating}
          className="bg-brand-deep hover:bg-brand-dark text-white px-6 py-2.5 rounded-lg font-bold text-sm transition-all shadow-sm flex items-center gap-2 disabled:opacity-50"
        >
          {creating ? (
            <>
      ...
      {submissions.length === 0 ? (
        ...
        <div className="bg-white border border-brand-sage/20 rounded-lg overflow-hidden">
