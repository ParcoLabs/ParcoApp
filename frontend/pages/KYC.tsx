...
export const KYC: React.FC = () => {
  ...
  // 1. Intro / Status Screen (Matches "Account Level" Screenshot)
  const IntroStep = () => (
  ...
  // 2. Identity Info (Matches "Getting Started" Screenshot)
  const IdentityStep = () => (
    <div className="max-w-md mx-auto">
        <div className="mb-8">
  ...
  // 4. OTP Verification (Matches "Enter the 6-digit code" Screenshot)
  const OtpStep = () => (
    <div className="max-w-md mx-auto">
        <div className="mb-8">
  ...
  // 6. Document Type (Matches "Choose your document type" Screenshot)
  ...
  // 8. Scan Back (Matches "Scan the Back" Screenshot)
  const ScanBackStep = () => (
    <div className="max-w-md mx-auto text-center h-full flex flex-col">
        <div className="mb-4">
  ...
  return (
    <div className="min-h-screen bg-brand-offWhite p-6 pb-20">
      ...
      {step === 'document_type' && <DocumentTypeStep />}
      {step === 'scan_front' && <ScanFrontStep />}
      {step === 'scan_back' && <ScanBackStep />}
