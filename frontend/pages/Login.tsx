    ...
    <div className="min-h-screen bg-brand-offWhite flex flex-col justify-center items-center p-4 md:p-6">
      <div className="w-full max-w-md">
        <div className="mb-6 md:mb-8 text-center">
          ...
          <h2 className="text-xl md:text-2xl font-bold text-brand-dark">Sign in to your Parco account</h2>
        </div>
        ...
        <div className="mt-4 md:mt-6 text-center">
          <span className="text-sm text-brand-sage">Don't have an account? </span>
          <Link to="/register" className="text-sm font-bold text-brand-deep hover:underline">
            Create Account
          </Link>
        </div>
      </div>
