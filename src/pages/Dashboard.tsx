  ...
  if (demoMode) {
    ...
    return (
      <div className="p-4 md:p-8 max-w-5xl mx-auto space-y-6 pt-20 md:pt-8 pb-24 md:pb-8">
        ...
        <div>
          <h2 className="text-xl font-bold text-brand-dark dark:text-white mb-4">Assets</h2>
            ...
            <div className="space-y-3">
              {Object.entries(walletBalances).map(([key, crypto]: [string, any]) => (
                ...
                >
                  ...
                  <div className="text-right">
                    <p className="font-bold text-brand-dark dark:text-white">${crypto.balance.toLocaleString()}</p>
                  </div>
                </div>
              ))}
            </div>
        ...
        <div>
          <h2 className="text-xl font-bold text-brand-dark dark:text-white mb-4">Marketplace</h2>
          <div className="space-y-3">
            {PREVIEW_PROPERTIES.map((prop) => (
              ...
              >
                ...
                <div className="text-right">
                  <p className="text-xs text-brand-dark dark:text-white">Value: <span className="font-bold">${prop.value} USDC</span></p>
                  <p className="text-xs text-brand-dark dark:text-white">APY <span className="font-bold">({prop.apy}%)</span></p>
                </div>
              </div>
            ))}
          </div>
  ...
  return (
    <div className="p-4 md:p-8 max-w-4xl mx-auto space-y-8 pt-20 md:pt-8 pb-24 md:pb-8">
      ...
      <div className="flex justify-between items-start">
        <div>
          <h1 className="text-4xl font-bold text-brand-dark dark:text-white mb-1">
            $0.00
          </h1>
          <p className="text-brand-dark dark:text-white text-sm font-bold tracking-wide uppercase">Total Property Value</p>
        </div>
          ...
          {PREVIEW_PROPERTIES.map((prop) => (
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="text-sm font-bold text-brand-dark dark:text-white">{prop.title}</h3>
                  <p className="text-xs text-brand-dark dark:text-white font-medium">{prop.location}</p>
                </div>
              </div>
              
              <div className="text-right">
                <div className="text-xs text-brand-dark dark:text-white font-medium">
